  ...
  async function loadPrinters(token: string, silent = false) {
    ...
    if (sessionStorage.getItem("partneron_demo_mode") === "true") {
      setPrinters([
        ...
        {
          id: 3,
          serial_no: "FX-5529188",
          model_name: "Fujifilm Apeos C3070",
          customer_name: "(주) 글로벌 솔루션 강남점",
          location: "3층 디자인팀",
          ...
          count_mono: 31400,
          count_total: 129600,
          last_scanned_at: "2026-08-11T14:31:10Z",
          is_online: true,
        },
        {
          id: 4,
          serial_no: "CN-9920134",
          model_name: "Canon imageRUNNER C3226i",
          customer_name: "(주) 한빛 미디어 본사",
          location: "4층 연구소",
          ip_address: "10.0.4.12",
          count_color: 8900,
          count_mono: 65300,
          count_total: 74200,
          last_scanned_at: "2026-08-11T14:29:50Z",
          is_online: true,
        },
        {
          id: 5,
          serial_no: "FX-1102948",
          model_name: "Fujifilm ApeosPort C2570",
          customer_name: "(주) 한빛 미디어 본사",
          location: "지하 1층 인쇄실",
          ...
          count_mono: 280000,
          count_total: 434000,
          last_scanned_at: "2026-08-11T14:30:45Z",
          is_online: true,
        },
      ] as any);
      setLoading(false);
