...
* **[사전 승인 필수]**: 사용자의 질문/지시에 사전 승인 없이 **소스코드, .md 문서 작성/수정, Git 커밋 및 푸시(push)를 포함한 일체의 파일 변경이나 Git 명령을 임의로 먼저 수행하지 않습니다.**
* **[개발자 식별 수칙]**: 세션 시작 시 **작업 담당자 성함/닉네임**을 확인하여 ADR 및 Commit/PR에 수반 기록합니다. (기본: `HR`)
